...
pseudoref.sample <- apply(counts.all, 1, gm_mean)

median((counts.all/pseudoref.sample), na.rm =TRUE)

size.factor <- apply(counts.all, 1, median((counts.all/pseudoref.sample), na.rm =TRUE) )
## Copute the size factor for each sample (column)
