...
knitr::kable(t(stats.per.sample[1:9,]))
...
hist(log10(apply(counts, 2, sum)), breaks=50,
     main="Sum of counts per sample", col="#DDEEFF",
     xlab="Log10(sum of counts)", ylab="Number of samples", xlim=c(6.7,7.2))
