...
Standardize the count table by scaling all values accoding to the median per sample (do it for the counts and for the log2-transformed counts).
...
#### Normalizing effect of the log2 transformation
...
### Exercise 3. Statistics per gene (rows of the count table)
...
### Exercise 4. Comparison between WT and mutant genotypes
