...
**Motivation: ** now we will apply a filter to discard genes that remain undetectedin almost all the samples.
...
4. We compte a Boolean vector indicating whether each gene has been detected in at least 2 samples. We discard all the genes that fail to pass this criterion. 
