...
Interpretation of the result: in the two first components, the distance between samples is an approximation of the similarity betwen their count profiles per gene. 
...
Mustafa: please find the original paper from edgeR, where they describe all these statistics (e.g. the biological coefficient of variation), and try to understand what it represents; Then we discuss next week. 
